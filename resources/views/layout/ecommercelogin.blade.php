...
<body>
    ...
    if ($status == "ok") {
        ...
        $message=LoginManager::isEmailAndPasswordCorrect($email,$password);
        if(!$message){
            ...
            <form action="" method="post">
                <div class="row box">
                    <div class="col-md-12 ">
                        ...
                        <h3>Email </h3> <input class="input " type="text" name="email" placeholder="Email" required />
